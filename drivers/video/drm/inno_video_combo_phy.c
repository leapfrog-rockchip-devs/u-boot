...
struct inno_video_phy {
	struct udevice *dev;
	enum phy_mode mode;
	const struct inno_video_mipi_dphy_info* const *mipi_dphy_infos;
	struct resource phy;
...
inno_mipi_dphy_get_timing(struct inno_video_phy *inno)
{
	...
	index = inno->max_rate;
	timings = inno->mipi_dphy_infos[index]->inno_mipi_dphy_timing_table;
	num_timings = inno->mipi_dphy_infos[index]->num_timings;
...
static void inno_video_phy_mipi_mode_enable(struct inno_video_phy *inno)
{
	...
	inno->max_rate = soc_is_px30s() ? MAX_2_5GHZ : phy->max_rate;
	...
	if (phy->soc_type == PX30_VIDEO_PHY)
...
static const
struct inno_video_mipi_dphy_info inno_video_mipi_dphy_max_1GHz = {
	.inno_mipi_dphy_timing_table = inno_mipi_dphy_timing_table_max_1GHz,
	.num_timings = ARRAY_SIZE(inno_mipi_dphy_timing_table_max_1GHz),
};

static const
struct inno_video_mipi_dphy_info inno_video_mipi_dphy_max_2_5GHz = {
	.inno_mipi_dphy_timing_table = inno_mipi_dphy_timing_table_max_2_5GHz,
	.num_timings = ARRAY_SIZE(inno_mipi_dphy_timing_table_max_2_5GHz),
};

static const
struct inno_video_mipi_dphy_info *inno_video_mipi_dphy_timing_infos[MAX_RATE] = {
	[MAX_1GHZ] = &inno_video_mipi_dphy_max_1GHz,
	[MAX_2_5GHZ] = &inno_video_mipi_dphy_max_2_5GHz,
};
...
static struct rockchip_phy px30_inno_video_phy_driver_data = {
	...
	.data = inno_video_mipi_dphy_timing_infos,
};
